     ...
     <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo isset($_GET['target']) && $_GET['target'] == 'siswa' ? "active" : ""; ?>" href="<?php echo base_url(); ?>admin.php?target=siswa"><i class="fa-solid fa-building-columns"></i> Data Siswa </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo isset($_GET['target']) && $_GET['target'] == 'wk' ? "active" : ""; ?>" href="<?php echo base_url(); ?>admin.php?target=wk"><i class="fa-solid fa-book"></i> Data wali kelas</a>
            </li>
