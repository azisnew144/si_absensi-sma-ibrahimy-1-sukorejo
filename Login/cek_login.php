...
if($user_valid){
    ...
    //cek password sesuai atau tidak 
     if($password == $user_valid['password']) {
        ...
        //uji lebvel user
        if ($level == "Guru"){
            header('location:Guru/file/');
        } elseif ($level == "Siswa"){
            header('location:Siswa/file/');
        } elseif ($level == "Administrator"){
            header('location:Administrator/file/');
        } elseif ($level == "wk"){
            header('location:wk/file/');
        }
     } else {
        echo "<script>alert('Maaf, Login Gagal, Password anda tidak sesuai's);document.location='index.php'</script>"; 
    }
} else {
